...
class ItemControllerTest {
    ...
    private final UserDtoIdAndName userDtoShortOleg = new UserDtoIdAndName(userDtoOleg.getId(), userDtoOleg.getName());
    ...
    private final ItemDtoIdAndName itemDtoShortDryer = new ItemDtoIdAndName(itemDtoDryer.getId(), itemDtoDryer.getName());
    ...
    private final ItemDtoBookingAndComments itemWithCommentsAndBookings = new ItemDtoBookingAndComments(
            itemDtoDryer.getId(),
    ...
    void getAll_shouldSuccess() throws Exception {
        ...
        mvc.perform(
                ...
                .andExpect(
                        jsonPath("$.[0].nextBooking.id",
                                is(itemWithCommentsAndBookings.getNextBooking().getId()), Long.class)
                )
                .andExpect(
                        jsonPath(
